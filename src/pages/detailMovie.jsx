...
// import RatingModal from "../components/Fragments/Modal";
...
//     console.log({ rate: storedRating });
//     if (storedRating) {
//       const parsedRating = JSON.parse(storedRating);
//       console.log({ parseRate: parsedRating });
//       if (parsedRating[id]) {
//         setRating(parsedRating[id]);
//       }
//     }
//   }, [id]);
